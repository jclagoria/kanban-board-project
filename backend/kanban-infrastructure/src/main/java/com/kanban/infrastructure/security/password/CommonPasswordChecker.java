...
public class CommonPasswordChecker implements com.kanban.core.port.output.CommonPasswordChecker {
    ...
    private static final Set<String> COMMON_PASSWORDS = Set.of(
        ...
        "cheese", "arsenal", "charlie", "thomas", "jordan", "jennifer", "joshua",
        "matthew", "andrew", "robert", "samuel", "william", "joseph", "daniel",
        "chocolate", "pepper", "michigan", "cowboys", "yankees", "liverpool", "chelsea",
        "arsenal", "redskins", "packers", "broncos", "eagles", "vikings", "patriots",
