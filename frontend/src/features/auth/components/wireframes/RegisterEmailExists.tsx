...
export default function RegisterEmailExists({ showStructure }: { showStructure?: boolean }) {
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div style={shellCss}>
        ...
        <Card>
          {showStructure && <RegionLabel top={-4} left={0}>Card — Registration Form (Error: Email exists)</RegionLabel>}
