...
export default function RegisterPage({ showStructure }: { showStructure?: boolean }) {
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div style={shellCss}>
        ...
        <Card>
          {showStructure && <RegionLabel top={-4} left={0}>Card — Registration Form</RegionLabel>}
          ...
          {showStructure && <RegionLabel top={-4} left={0}>Social Auth — Coming Soon (dimmed)</RegionLabel>}
          <div style={orRowCss}>
